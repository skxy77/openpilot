...
TRAFFIC_GAP_V  = [2.8, 2.8,  3.5,  5.0,  7.0,  8.0,  10.0,  13.0,  16.0,  22.0,  28.0,  36.0, 41.7, 50.0]
...
def gen_long_ocp():
  ...
  desired_dist_comfort = get_safe_obstacle_distance(v_ego, lead_t_follow, log.LongitudinalPersonality.standard)
